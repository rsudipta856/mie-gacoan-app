...
// Menu lengkap dengan gambar yang benar (sesuai yang ada di public/images)
const COMPLETE_MENU_ITEMS: MenuItem[] = [
  // MIE CATEGORY (15 items)
  {
    ...
    name: "MIE SUIT",
    price: 10500,
    image_url: "/images/food-menu.png", // Gunakan yang sudah ada
    category: "MIE",
    is_available: true,
  ...
  // DIMSUM CATEGORY (12 items)
  {
    ...
    name: "SIOMAY",
    price: 9500,
    image_url: "/images/food-menu.png", // Gunakan food-menu.png untuk semua dimsum
    category: "DIMSUM",
    is_available: true,
  ...
  // MINUMAN DINGIN CATEGORY (15 items)
  {
    ...
    name: "ES GOBAK SODOR",
    price: 9500,
    image_url: "/images/beverages.png", // Gunakan beverages.png untuk minuman
